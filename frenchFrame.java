...
public class frenchFrame extends javax.swing.JFrame {
    ...
    private String[] list = {"Merci", "Amour", "Temps", "Belle", "Chien", "Coute", "Bruler", "Jouer", "Avoir", "Calin"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("N'est pas Wordle");

        guessB.setText("Supposer");
        ...
        langB.setText("Changer de Langue");
        ...
        String gues = "Suppositions à Gauche: " + guesLeft;
        ...
        jLabel35.setText("Mots Inutilisés: " + wordsLeft);
    ...
    private void guessBActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(!hasWon) {
            if (guesLeft != 0) {
                ...
                if (blah.length() == 5) {
                    if (guesLeft == 6) {
                        ...
                        jLabel29.setText(gues1);
                        guesLeft--;
                        jLabel28.setText("Suppositions a Gauche: " + guesLeft);
                        jTextField1.setText("");
                        getWin(blah);
                        changeColors(blah);
                        if(hasWon){
                            JOptionPane.showMessageDialog(null, "Tu as gagné, wow c'était rapide, est-ce que tu triches?" + "\n" + "Quoi qu'il en soit, votre prix est un pull emoji!");
                            JOptionPane.showMessageDialog(null, "L'Emoji", "Prix",JOptionPane.INFORMATION_MESSAGE,emoji);
                        ...
                        changeColors(blah);
                        if(hasWon){
                            JOptionPane.showMessageDialog(null, "Tu as gagné, c'était rapide!" + "\n" + "Quoi qu'il en soit, votre prix est un pull emoji!");
                            JOptionPane.showMessageDialog(null, "L'Emoji", "Prix",JOptionPane.INFORMATION_MESSAGE,emoji);
                            mainScreen.incrementWins();
                        }
                    } else if (guesLeft == 4) {
                        ...
                        changeColors(blah);
                        if(hasWon){
                            JOptionPane.showMessageDialog(null, "Tu as gagné, tres bien!" + "\n" + "Quoi qu'il en soit, votre prix est un pull emoji!");
                            JOptionPane.showMessageDialog(null, "L'Emoji", "Prix",JOptionPane.INFORMATION_MESSAGE,emoji);
                            mainScreen.incrementWins();
                        }
                    } else if (guesLeft == 3) {
                        ...
                        changeColors(blah);
                        if(hasWon){
                            JOptionPane.showMessageDialog(null, "Tu as gagné, bien" + "\n" + "Quoi qu'il en soit, votre prix est un pull emoji!");
                            JOptionPane.showMessageDialog(null, "L'Emoji", "Prix",JOptionPane.INFORMATION_MESSAGE,emoji);
                        }
                    } else if (guesLeft == 2) {
                        ...
                        changeColors(blah);
                        if(hasWon){
                            JOptionPane.showMessageDialog(null, "Tu as gagné, ça t'a pris suffisamment longtemps!" + "\n" + "Quoi qu'il en soit, votre prix est un pull emoji!");
                            JOptionPane.showMessageDialog(null, "L'Emoji", "Prix",JOptionPane.INFORMATION_MESSAGE,emoji);
                            mainScreen.incrementWins();
                        }
                    } else if (guesLeft == 1) {
                        ...
                        if(guesLeft == 0) {
                            if (hasWon) {
                                JOptionPane.showMessageDialog(null, "Tu as gagné, je pense que tu ne vas pas a gagne!" + "\n" + "Quoi qu'il en soit, votre prix est un pull emoji!");
                                JOptionPane.showMessageDialog(null, "L'Emoji", "Prix", JOptionPane.INFORMATION_MESSAGE, emoji);
                                mainScreen.incrementWins();
                            }
                            else{
                                JOptionPane.showMessageDialog(null, "Vous n'avez plus de suppositions sur votre mot '"+ ranWord + "'" +"\n" +"S'il vous plait appuyer sur \"Nouveau\" pour continuer à jouer");
            ...
            JOptionPane.showMessageDialog(null, "Tu as deja gange! Felicitations"+"\n" +"S'il vous plait appuyer \"Nouveau\" pour continuer a jouer" + "\n" + "Ou appuyer \"Changer de Langue\" pour jouer dans une autre langue");
        }
        typeGuess = "";
    }
    ...
    private void newBActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(!getATrue()){
            ...
            JOptionPane.showMessageDialog(null, "Un nouveau mot a été choisi, devinez!");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frenchFrame().setVisible(true);
            }
        });
    }
